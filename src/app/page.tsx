    ...
    <div className="flex flex-col min-h-screen bg-gray-900">
      ...
      <main className="flex-grow container mx-auto p-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 h-[calc(100vh-5rem)]">
          ...
          <div className="flex flex-col gap-4 h-full">
            <div className="bg-gray-800 shadow-lg overflow-hidden flex-1 max-h-[calc(75vh-2.5rem)]">
              <MapComponent mapId="main-map" />
            </div>
            <div className="bg-gray-800 shadow-lg overflow-hidden flex-1 max-h-[calc(25vh-2.5rem)]">
              <LayerConfig />
            </div>
          </div>
        </div>
